...
#    print ()
	 ...
	 # for a16skey in kmer_16s_sequences.keys():
		...
		# 		ji = JaccardIndex(kmer_sample_sequences[asamplekey],kmer_16s_sequences[a16skey])
		# 		if ji > 0:
		# 			print(ji)
...
k_lib = ConvertLibaryToKmerSets(lib, K=2)
k_samp = ConvertLibaryToKmerSets(samp, K=2)


for lib_key in k_lib.keys():
    for samp_key in k_samp.keys():
        print(JaccardIndex(k_samp[samp_key], k_lib[lib_key]))
